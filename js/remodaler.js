class Remodaler {
  ...
  show = options => {
    ...
    win.querySelector("button[data-remodal-action='confirm']").innerText = this._options.confirmText || 'Confirm';
    win.querySelector("button[data-remodal-action='cancel']").innerText = this._options.cancelText || 'Cancel';
